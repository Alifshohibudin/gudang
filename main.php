...
// jika user sudah login, tampilkan halaman konten
  ...
  <head>
    ...
    <meta name="description" content="PT DIRGANTARA CAHAYA ABADI" />
    <meta name="author" content="Alif Shohibudin" />

    <!-- Title -->
    <title>PT DIRGANTARA CAHAYA ABADI</title>

    <!-- Favicon icon -->
    <link rel="icon" href="assets/img/logo-dirca.png" type="image/x-icon" />
  ...
  <body>
        ...
        <div class="logo-header" data-background-color="purple">
          ...
          <a href="?module=dashboard" class="logo">
            <div class="navbar-brand">
              <span><i class="fab fa-stripe-s circle fa-lg text-warning"></i></span>
              <span class="text-white">tock Barang</span>
            </div>
          </a>
          <!-- Navbar Toggler -->
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="copyright ml-auto">
              Copyright &copy; 2024 - <a href="#" class="text-secondary">PT DIRGANTARA CAHAYA ABADI</a>.
            </div>
          </div>
        </footer>
        <!-- End Footer -->
    ...
    <script src="https://kit.fontawesome.com/40a0eed7eb.js" crossorigin="anonymous"></script>
  </body>
