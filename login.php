...
<body class="login">
  ...
  <div class="wrapper wrapper-login">
    <div class="container container-login animated fadeIn">
      <!-- logo -->
      <div class="text-center mb-4"><img src="assets/img/logo-dirca.png" alt="Logo" width="95px"></div>
      <!-- judul -->
      <h3 class="text-center">PT DIRGANTARA CAHAYA ABADI <br>Stock Barang</h3>
      <!-- form login -->
      <form action="proses_login.php" method="post" class="needs-validation" novalidate>
        ...
        <div class="login-footer mt-4">
          <span class="msg">&copy; PT DIRGANTARA CAHAYA ABADI 2024</span>
         </div>
      </form>
    </div>
  </div>
